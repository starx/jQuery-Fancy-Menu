/*
 * jQuery Fancy Columns Animations v@1.0
 * http://projects.mrnepal.com/jquery/fancy-columns/
 * https://github.com/starx/jQuery-Fancy-Columns
 *
 ...
 */
(function($) {
	$.fn.fancyColumns = function(options){
		var settings = $.extend({
			'effects' : {
				'stair' : true,
				'transition' : true
